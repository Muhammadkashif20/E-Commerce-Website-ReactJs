      ...
      <header className="text-gray-600 body-font bg-gray-200 shadow-lg fixed w-full top-0">
        <div className="container mx-auto flex flex-wrap p-5 items-center justify-between">
          <a className="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
            <span className="text-2xl transition-transform duration-300 hover:scale-105 ">Life Essentials Hub <span className='text-3xl'>🛒</span></span>
          </a>
          
          <div className="flex-grow mx-5 ms-10">
            <input 
              type="text" 
              placeholder="Search..." 
          ...
          <div className="flex items-center ms-2" >
            ...
            <button className="inline-flex items-center ms-2 bg-blue-500 text-white border-0 py-1 px-3 focus:outline-none hover:bg-blue-600 transition duration-200 rounded text-base">
              Login
            </button>
          </div>
        </div>
